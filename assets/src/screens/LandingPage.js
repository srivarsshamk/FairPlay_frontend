              ...
              <View key={index} style={styles.featureCarouselItem}>
                ...
                <View style={styles.featureContent}>
                  ...
                  <TouchableOpacity style={styles.learnMoreButton}>
                    <Text style={styles.learnMoreButtonText} onPress={() => navigation.push('Login')}>{t("features.learnMore")}</Text>
                  </TouchableOpacity>
                </View>
              </View>
            ))}
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroSection}>
          <View style={styles.heroContent}>
            <Text style={styles.heroTitle}>
              {t("hero.title1")}{" "}
              <Text style={styles.greenText}>{t("hero.title2")}</Text>
            </Text>
        ...
        <View style={styles.aboutdSection}>
          <Animated.Image
            source={{
              uri: "https://www.dropbox.com/scl/fi/o31rq1ghfxfdywma18l3n/AboutDoping.png?rlkey=wx0zgu5oyphy9sdozzf52jkvn&st=s5yd0z21&raw=1",
            }}
            style={[
              styles.image,
              {
        ...
        <View style={styles.solutionsContainer}>
          <Text style={styles.sectionTitle}>
            {t("features.title1")}{" "}
            <Text style={styles.greenText}>{t("features.title2")}</Text>
          </Text>
          <FeatureCarousel />
        </View>
